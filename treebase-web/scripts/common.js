	...
	function () {
	    if ( document.getElementsByClassName ) {
            ...
            if ( checkBoxCells.length > 0 && buttonContainer ) {
                var checkButton = new Element('input',{'type':'button','value':'Check all', 'className': 'styled-button2'});
                ...
                var uncheckButton = new Element('input',{'type':'button','value':'Uncheck all','className':'styled-button2'});
                ...
                var invertButton = new Element('input',{'type':'button','value':'Invert','className':'styled-button2'});
