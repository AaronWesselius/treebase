...
<tr>
 <td colspan="3" align="center"> 
 	<input type="submit" class="styled-button" name="_target0" value="<fmt:message key="button.previous"/>" />
 	<input type="submit" class="styled-button" name="_finish" value="<fmt:message key="button.finish"/>" />
 	<input type="submit" class="styled-button" name="_cancel" value="<fmt:message key="button.cancel"/>" />
 </td>
</tr>
</table>
