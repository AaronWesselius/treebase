...
<div class="gutter">
    ...
    <div class="grid-containertwowide">
        ...
        <h2>Preparation of taxon labels</h2>
        ...
        <br>
        <p>
            <iframe width="420" height="236" src="//www.youtube.com/embed/2npvFJX31hs?list=PL9AD9904B8782D600" frameborder="0" allowfullscreen></iframe>
        </p>
    ...
    <div class="grid-containertwowide">
        ...
        <p>
            <iframe width="420" height="236" src="//www.youtube.com/embed/0bdKW5-Lg7E?list=PL3F38DFE2626A5234" frameborder="0" allowfullscreen></iframe>
        </p>
    </div>
