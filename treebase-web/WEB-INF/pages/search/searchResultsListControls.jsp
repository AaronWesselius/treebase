...
<!-- 
 ...
 -->
  ...
  <input type="submit" class="styled-button3" id="refineSearch" value="Discard Unchecked Items" onclick="doAction('refineSearch')"/>
  ...
  <input style="align: right;" type="submit" class="styled-button3" id="discardResults" value="Discard All Results" onclick="confirmDiscard()"/>
