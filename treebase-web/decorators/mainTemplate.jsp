...
<link rel="stylesheet" type="text/css" href="<c:url value='/styles/card.css'/>" />
<link rel="stylesheet" type="text/css" href="<c:url value='/styles/maincontentgrid.css'/>" />
<link rel="stylesheet" type="text/css" href="<c:url value='/styles/templategrid.css'/>" />
