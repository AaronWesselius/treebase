...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/maincontentgrid.css'/>" />
...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/header.css'/>" />
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/login.css'/>" />
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/submission.css'/>" />
